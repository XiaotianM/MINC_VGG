...
all_data = MINC2500(root_dir='/data/DataSet/minc/data/minc-2500/', set_type='train', split=1, transform=transforms.ToTensor())
all_loader = torch.utils.data.DataLoader(dataset=all_data, batch_size=100, num_workers=8)
